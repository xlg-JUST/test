...
class GasBar extends Bar
{
    ...
    public function init()
    {
        ...
        $color = Admin::color();
        $second_color = $color->alpha('#000000', 0.3);
...
<div class="d-flex p-1 flex-column justify-content-between" style="padding-top: 0;width: 100%;height: 100%;min-height: {$minHeight}">
    ...
    <a href="http://test.local/admin/gaslevel" class="btn btn-primary shadow waves-effect waves-light">View Details <i class="feather icon-chevrons-right"></i></a>
</div>
HTML
        );
    }
